...
import { ConstDirectiveNode, GraphQLSchema, TypeNode, SelectionSetNode, DocumentNode } from 'graphql';
...
type ProgressiveOverrideHandler = (label: string, context: any, info: GraphQLResolveInfo) => boolean;
declare function getRngFromEnv(): number | undefined;
declare const progressiveOverridePossibilityHandler: (possibility: number, getRng: (() => number) | undefined) => boolean;
declare function extractPercentageFromLabel(label: string): number | undefined;
/**
 ...
 */
declare function parseJoinDirective(directiveNode: ConstDirectiveNode): {
    graphNames: string[];
    directive: ConstDirectiveNode;
} | null;
declare function filterDirectivesByGraph(graphName: string, directives: readonly ConstDirectiveNode[] | undefined, filterDirectives: string[]): readonly ConstDirectiveNode[] | undefined;
...
interface ProgressiveOverrideInfo {
    field: string;
    from: string;
    label: string;
}

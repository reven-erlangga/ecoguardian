            ...
            if ((0, graphql_1.isEnumType)(type)) {
                ...
                for (const fieldName in fields) {
                    ...
                    if (isListTypeByAnyMeans(field.type)) {
                        field.resolve = wrapListFieldResolver(field.resolve || graphql_1.defaultFieldResolver);
                    }
                }
            }
        }
...
function isListTypeByAnyMeans(type) {
...
function wrapListFieldResolver(fieldResolver) {
    return function listFieldResolver(root, args, context, info) {
        return (0, promise_helpers_1.handleMaybePromise)(() => fieldResolver(root, args, context, info), result => {
            if (result == null) {
                return [];
            }
            return result;

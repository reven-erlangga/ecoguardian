...
import { generateIncontextSDKTypes, generateUnifiedContextTypeFromIdentifiers, } from '@graphql-mesh/incontext-sdk-codegen';
import { defaultImportFn, pathExists, printWithCache, writeFile, writeJSON, } from '@graphql-mesh/utils';
            ...
            pluginMap: {
                ...
                contextSdk: {
                    plugin: async () => {
                        ...
                        let contextType = generateUnifiedContextTypeFromIdentifiers(results.map(r => r.identifier).filter((id) => Boolean(id)));

...
class GrpcHandler {
    ...
    getCachedNonExecutableSchema() {
        ...
        return this.schemaWithAnnotationsProxy.getWithSet(() => (0, grpc_1.loadGrpcSubgraph)(this.sourceName, this.config)({ cwd: this.baseDir, logger: this.logger })
            .schema$);
    }
    getMeshSource() {
        const transport = new transport_grpc_1.GrpcTransportHelper(this.sourceName, this.baseDir, this.logger, this.config.endpoint, this.config);

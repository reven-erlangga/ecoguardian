...
var fastSafeStringify$1 = stringify;
...
var fastSafeStringify = /*@__PURE__*/getDefaultExportFromCjs(fastSafeStringify$1);

function jsonStringify(val, pretty) {
  return fastSafeStringify(val, void 0, pretty ? 2 : void 0);
}

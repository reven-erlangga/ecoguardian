...
import { GraphQLError, GraphQLFieldResolver, GraphQLTypeResolver, GraphQLIsTypeOfFn, GraphQLSchema, OperationDefinitionNode, FragmentDefinitionNode, ExecutionResult, DocumentNode, GraphQLObjectType, GraphQLOutputType, FieldNode, GraphQLFormattedError, ASTNode, GraphQLField, GraphQLScalarType, ConstValueNode, SelectionSetNode, GraphQLDirective, DirectiveNode, ValueNode, GraphQLInputType, SourceLocation, VariableNode, GraphQLArgument, ArgumentNode } from 'graphql';
...
type Serializer = (c: ExecutionContext, v: any, onError: any, ...idx: number[]) => any;
declare const jitRuntime: {
    isPromise(value: unknown): boolean;
    checkNonNullLeaf(ctx: ExecutionContext, value: unknown, dest: any[], nullMsg: string, locs: any, path: any, capStack: boolean, serialize: Serializer, errHandler: any, ...parentIndexes: number[]): any;
    checkNullableLeaf(ctx: ExecutionContext, value: unknown, dest: any[], locs: any, path: any, capStack: boolean, serialize: Serializer, errHandler: any, ...parentIndexes: number[]): any;
    callResolver(ctx: ExecutionContext, call: () => unknown, onSuccess: (result: unknown) => void, onError: (err: unknown) => void): void;
    handleResolverResult(ctx: ExecutionContext, value: unknown, onSuccess: (result: unknown) => void, onError: (err: unknown) => void): void;
    handleListItemResult(ctx: ExecutionContext, item: unknown, onSuccess: (result: unknown) => void, onError: (err: unknown) => void): void;
    finalizeResult(ctx: ExecutionContext): Promise<unknown> | undefined;
    safeMap(ctx: ExecutionContext, iterable: Iterable<unknown> | string, cb: (context: ExecutionContext, a: unknown, index: number, resultArray: unknown[], ...idx: number[]) => void, ...idx: number[]): unknown[];
};
type JitRuntime = typeof jitRuntime;
 ...
 */
declare function buildCompilationContext(schema: GraphQLSchema, document: DocumentNode, options: CompilerOptions, operationName?: string): CompilationContext;
 ...
 */
declare function coerceInputLiteral(type: GraphQLScalarType<unknown, unknown>, valueNode: ConstValueNode): any;
...
export { type Arguments as A, type CompilationContext as C, type ExecutionContext as E, type FieldsAndNodes as F, GLOBAL_VARIABLES_NAME as G, type JitRuntime as J, type NullTrimmer as N, type ObjectPath as O, type CompilerOptions as a, type CompiledQuery as b, createNullTrimmer as c, compileQuery as d, createBoundQuery as e, isPromise as f, isPromiseInliner as g, buildCompilationContext as h, isCompiledQuery as i, jitRuntime as j, isAsyncIterable as k, getOperationRootType as l, formatError as m, getGraphQLErrorOptions as n, coerceInputLiteral as o, type JitFieldNode as p, collectFields as q, resolveFieldDef as r, collectSubfields as s, getArgumentDefs as t, computeLocations as u, valueFromAST as v, addPath as w, flattenPath as x, serializeObjectPathForSkipInclude as y, joinSkipIncludePath as z };

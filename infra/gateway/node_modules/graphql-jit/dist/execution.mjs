...
import { jitRuntime } from "./runtime";
...
function compileType(context, parentType, type, fieldNodes, originPaths, destinationPaths, previousPath) {
  ...
  if (isLeafType(innerType) && !(context.options.disableLeafSerialization && (innerType instanceof GraphQLEnumType || isSpecifiedScalarType(innerType)))) {

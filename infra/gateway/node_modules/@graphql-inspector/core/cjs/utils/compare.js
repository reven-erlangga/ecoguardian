...
exports.compareDirectiveLists = compareDirectiveLists;
exports.keyMapList = keyMapList;
 ...
 */
function compareDirectiveLists(oldList, newList, callbacks) {
...
function keyMapList(list, keyFn) {
    return list.reduce((map, item) => {

...
function objectTypeInterfaceAddedFromMeta(args) {
    return {
        ...
        criticality: {
            level: args.meta.addedToNewType ? change_js_1.CriticalityLevel.NonBreaking : change_js_1.CriticalityLevel.Dangerous,
            reason: 'Adding an interface to an object type may break existing clients that are consuming a field returning the interface type that are not programming defensively against this new possible type.',
        },
...
function objectTypeInterfaceAdded(iface, type, addedToNewType) {

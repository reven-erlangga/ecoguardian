...
function enumValueAddedFromMeta(args) {
    ...
    return {
        ...
        criticality: {
            level: isSafe ? change_js_1.CriticalityLevel.NonBreaking : change_js_1.CriticalityLevel.Dangerous,
...
function enumValueAdded(type, value, addedToNewType) {
...
function enumValueDeprecationReasonChangedFromMeta(args) {
    return {
        ...
        path: [args.meta.enumName, args.meta.enumValueName, `@${graphql_1.GraphQLDeprecatedDirective.name}`].join('.'),
        meta: args.meta,
    };
}
...
function enumValueDeprecationReasonAdded(newEnum, _oldValue, newValue) {

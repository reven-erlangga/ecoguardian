...
function changesInInputObject(oldInput, newInput, addChange) {
    ...
    (0, compare_js_1.compareLists)(Object.values(oldFields), Object.values(newFields), {
        onAdded(field) {
            addChange((0, input_js_1.inputFieldAdded)(newInput, field, oldInput == null));
    ...
    (0, compare_js_1.compareDirectiveLists)(oldInput?.astNode?.directives || [], newInput.astNode?.directives || [], {
        onAdded(directive) {
            addChange((0, directive_usage_js_1.directiveUsageAdded)(graphql_1.Kind.INPUT_OBJECT_TYPE_DEFINITION, directive, newInput, oldInput === null));
            (0, directive_usage_js_1.directiveUsageChanged)(null, directive, addChange, newInput);
        },
        onMutual(directive) {
            (0, directive_usage_js_1.directiveUsageChanged)(directive.oldVersion, directive.newVersion, addChange, newInput);
        },
        onRemoved(directive) {
    ...
    if (newField.astNode?.directives) {
        (0, compare_js_1.compareDirectiveLists)(oldField?.astNode?.directives || [], newField.astNode.directives || [], {
            onAdded(directive) {
                ...
                (0, directive_usage_js_1.directiveUsageChanged)(null, directive, addChange, input, newField);
            },
            onMutual(directive) {
                (0, directive_usage_js_1.directiveUsageChanged)(directive.oldVersion, directive.newVersion, addChange, input, newField);
            },
            onRemoved(directive) {

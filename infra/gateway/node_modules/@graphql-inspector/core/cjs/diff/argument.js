    ...
    if (newArg.astNode?.directives) {
        (0, compare_js_1.compareDirectiveLists)(oldArg?.astNode?.directives || [], newArg.astNode.directives || [], {
            onAdded(directive) {
                ...
                (0, directive_usage_js_1.directiveUsageChanged)(null, directive, addChange, type, field, newArg);
            },
            onMutual(directive) {
                (0, directive_usage_js_1.directiveUsageChanged)(directive.oldVersion, directive.newVersion, addChange, type, field, newArg);
            },
            onRemoved(directive) {

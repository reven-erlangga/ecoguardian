...
function changesInObject(oldType, newType, addChange) {
    ...
    (0, compare_js_1.compareLists)(oldInterfaces, newInterfaces, {
        onAdded(i) {
            addChange((0, object_js_1.objectTypeInterfaceAdded)(i, newType, oldType === null));
        },
        onRemoved(i) {
    ...
    (0, compare_js_1.compareLists)(Object.values(oldFields), Object.values(newFields), {
        onAdded(f) {
            ...
            (0, field_js_2.changesInField)(newType, null, f, addChange);
        },
        onRemoved(f) {
            addChange((0, field_js_1.fieldRemoved)(oldType, f));
        },
        onMutual(f) {
            (0, field_js_2.changesInField)(newType, f.oldVersion, f.newVersion, addChange);
        },
    });
    (0, compare_js_1.compareDirectiveLists)(oldType?.astNode?.directives || [], newType.astNode?.directives || [], {
        onAdded(directive) {
            addChange((0, directive_usage_js_1.directiveUsageAdded)(graphql_1.Kind.OBJECT, directive, newType, oldType === null));
            (0, directive_usage_js_1.directiveUsageChanged)(null, directive, addChange, newType);
        },
        onMutual(directive) {
            (0, directive_usage_js_1.directiveUsageChanged)(directive.oldVersion, directive.newVersion, addChange, newType);
        },
        onRemoved(directive) {

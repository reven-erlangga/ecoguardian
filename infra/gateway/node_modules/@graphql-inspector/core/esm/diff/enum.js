...
export function changesInEnum(oldEnum, newEnum, addChange) {
    ...
    compareDirectiveLists(oldEnum?.astNode?.directives || [], newEnum.astNode?.directives || [], {
        onAdded(directive) {
            addChange(directiveUsageAdded(Kind.ENUM_TYPE_DEFINITION, directive, newEnum, oldEnum === null));
...
function changesInEnumValue(value, newEnum, addChange) {
    ...
    compareDirectiveLists(oldValue?.astNode?.directives || [], newValue.astNode?.directives || [], {
        ...
        onMutual(directive) {
            directiveUsageChanged(directive.oldVersion, directive.newVersion, addChange, newEnum, undefined, undefined, newValue);
        },
        onRemoved(directive) {

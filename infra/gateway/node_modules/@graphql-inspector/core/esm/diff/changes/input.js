...
export function inputFieldAddedFromMeta(args) {
    let criticality;
    const addedNullableWithoutDefault = args.meta.isAddedInputFieldTypeNullable && args.meta.addedFieldDefault === undefined;
    if (args.meta.addedToNewType) {
        ...
        criticality = {
            ...
            reason: 'Adding a field with a default value can change runtime behavior for clients that previously omitted it, and during rolling deploys consumers may receive the new default before producers are ready to handle it.',
        };
    }
    return {

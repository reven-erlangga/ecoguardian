...
export declare function directiveDescriptionChanged(oldDirective: GraphQLDirective | null, newDirective: GraphQLDirective): Change<typeof ChangeType.DirectiveDescriptionChanged>;
export declare function directiveRepeatableAddedFromMeta(args: DirectiveRepeatableAddedChange): Change<typeof ChangeType.DirectiveRepeatableAdded>;
export declare function directiveRepeatableAdded(directive: GraphQLDirective): Change<"DIRECTIVE_REPEATABLE_ADDED">;
export declare function directiveRepeatableRemovedFromMeta(args: DirectiveRepeatableRemovedChange): Change<typeof ChangeType.DirectiveRepeatableRemoved>;
export declare function directiveRepeatableRemoved(directive: GraphQLDirective): Change<"DIRECTIVE_REPEATABLE_REMOVED">;
...
export declare function directiveArgumentAdded(directive: GraphQLDirective, arg: GraphQLArgument, addedToNewDirective: boolean): Change<typeof ChangeType.DirectiveArgumentAdded>;
...
export declare function directiveArgumentDescriptionChanged(directive: GraphQLDirective, oldArg: GraphQLArgument | null, newArg: GraphQLArgument): Change<typeof ChangeType.DirectiveArgumentDescriptionChanged>;
...
export declare function directiveArgumentDefaultValueChanged(directive: GraphQLDirective, oldArg: GraphQLArgument | null, newArg: GraphQLArgument): Change<typeof ChangeType.DirectiveArgumentDefaultValueChanged>;

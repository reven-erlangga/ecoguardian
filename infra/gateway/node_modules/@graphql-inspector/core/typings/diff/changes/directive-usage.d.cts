import { ConstDirectiveNode, GraphQLArgument, GraphQLEnumType, GraphQLEnumValue, GraphQLField, GraphQLInputField, GraphQLInputObjectType, GraphQLInterfaceType, GraphQLNamedType, GraphQLObjectType, GraphQLScalarType, GraphQLSchema, GraphQLUnionType, Kind } from 'graphql';
import { AddChange } from '../schema.cjs';
import { Change, ChangeType, CriticalityLevel, DirectiveAddedChange, DirectiveRemovedChange, DirectiveUsageArgumentAddedChange, DirectiveUsageArgumentDefinitionAddedChange, DirectiveUsageArgumentDefinitionRemovedChange, DirectiveUsageArgumentRemovedChange, DirectiveUsageEnumAddedChange, DirectiveUsageEnumRemovedChange, DirectiveUsageEnumValueAddedChange, DirectiveUsageEnumValueRemovedChange, DirectiveUsageFieldAddedChange, DirectiveUsageFieldDefinitionAddedChange, DirectiveUsageFieldDefinitionRemovedChange, DirectiveUsageFieldRemovedChange, DirectiveUsageInputFieldDefinitionAddedChange, DirectiveUsageInputFieldDefinitionRemovedChange, DirectiveUsageInputObjectAddedChange, DirectiveUsageInputObjectRemovedChange, DirectiveUsageInterfaceAddedChange, DirectiveUsageInterfaceRemovedChange, DirectiveUsageObjectAddedChange, DirectiveUsageObjectRemovedChange, DirectiveUsageScalarAddedChange, DirectiveUsageScalarRemovedChange, DirectiveUsageSchemaAddedChange, DirectiveUsageSchemaRemovedChange, DirectiveUsageUnionMemberAddedChange, DirectiveUsageUnionMemberRemovedChange } from './change.cjs';
type KindToPayload = {
    [Kind.FIELD]: {
        input: {
    ...
    [Kind.INPUT_VALUE_DEFINITION]: {
        ...
        change: DirectiveUsageArgumentDefinitionAddedChange | DirectiveUsageArgumentDefinitionRemovedChange;
    };
    [Kind.ARGUMENT]: {
        input: {
            field: GraphQLField<any, any, any>;
...
export declare function directiveUsageArgumentDefinitionAddedFromMeta(args: DirectiveUsageArgumentDefinitionAddedChange): {
...
export declare function directiveUsageSchemaAddedFromMeta(args: DirectiveUsageSchemaAddedChange): {
    readonly criticality: {
        readonly level: CriticalityLevel;
        readonly reason: `Directive '${string}' was added to schema`;
    };
...
export declare function directiveUsageSchemaRemovedFromMeta(args: DirectiveUsageSchemaRemovedChange): {
    readonly criticality: {
        readonly level: CriticalityLevel;
        readonly reason: `Directive '${string}' was removed from schema`;
    };
...
export type DirectiveUsageRemovedChange = typeof ChangeType.DirectiveUsageArgumentDefinitionRemoved | typeof ChangeType.DirectiveUsageInputFieldDefinitionRemoved | typeof ChangeType.DirectiveUsageInputObjectRemoved | typeof ChangeType.DirectiveUsageInterfaceRemoved | typeof ChangeType.DirectiveUsageObjectRemoved | typeof ChangeType.DirectiveUsageEnumRemoved | typeof ChangeType.DirectiveUsageFieldDefinitionRemoved | typeof ChangeType.DirectiveUsageUnionMemberRemoved | typeof ChangeType.DirectiveUsageEnumValueRemoved | typeof ChangeType.DirectiveUsageSchemaRemoved | typeof ChangeType.DirectiveUsageScalarRemoved | typeof ChangeType.DirectiveUsageFieldRemoved;
export declare function directiveUsageAdded<K extends keyof KindToPayload>(kind: K, directive: ConstDirectiveNode, payload: KindToPayload[K]['input'], addedToNewType: boolean): Change<DirectiveUsageAddedChange>;
...
export declare function directiveUsageArgumentAddedFromMeta(args: DirectiveUsageArgumentAddedChange): Change;
export declare function directiveUsageArgumentRemovedFromMeta(args: DirectiveUsageArgumentRemovedChange): Change;
export declare function directiveUsageChanged(oldDirective: ConstDirectiveNode | null, newDirective: ConstDirectiveNode, addChange: AddChange, parentType?: GraphQLNamedType, parentField?: GraphQLField<any, any> | GraphQLInputField, parentArgument?: GraphQLArgument, parentEnumValue?: GraphQLEnumValue): void;
export {};

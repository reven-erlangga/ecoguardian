...
export declare function inputFieldAdded(input: GraphQLInputObjectType, field: GraphQLInputField, addedToNewType: boolean): Change<typeof ChangeType.InputFieldAdded>;

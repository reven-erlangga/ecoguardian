...
export declare function objectTypeInterfaceAddedFromMeta(args: ObjectTypeInterfaceAddedChange): {
    ...
    readonly criticality: {
        ...
        readonly reason: "Adding an interface to an object type may break existing clients that are consuming a field returning the interface type that are not programming defensively against this new possible type.";
    };
...
export declare function objectTypeInterfaceAdded(iface: GraphQLInterfaceType, type: GraphQLObjectType | GraphQLInterfaceType, addedToNewType: boolean): Change<typeof ChangeType.ObjectTypeInterfaceAdded>;
...
export declare function objectTypeInterfaceRemoved(iface: GraphQLInterfaceType, type: GraphQLObjectType | GraphQLInterfaceType): Change<typeof ChangeType.ObjectTypeInterfaceRemoved>;
